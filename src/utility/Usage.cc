 ...
 * @return float
 */
float Stats::memoryDelta() const {
  float memory_end = static_cast<float>(memoryUsage());
  float memory_delta = memory_end - _memory_begin;
 ...
 * @return float
 */
float Stats::elapsedRunTime() const {
